...
//        return this;
    ...
    public void deleteList(ActivityResultLauncher<IntentSenderRequest> launcher, ArrayList<Uri> uriList){
        ContentResolver contentResolver = context.getContentResolver();
    ...
    public void trash(ActivityResultLauncher<IntentSenderRequest> launcher, Uri uri, boolean isTrash) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            ArrayList<Uri> collection = new ArrayList<>();
            collection.add(uri);
            pendingIntent = MediaStore.createTrashRequest(contentResolver, collection,isTrash);
    ...
    public void trashList(ActivityResultLauncher<IntentSenderRequest> launcher, ArrayList<Uri> uriList, boolean isTrash){
        ContentResolver contentResolver = context.getContentResolver();
