...
public class PhotoVaultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SetThemeColor.setThemeColor(Color.WHITE, ContextCompat.getColor(this, R.color.button), true, false, PhotoVaultActivity.this);
        setContentView(R.layout.activity_photo_vault);

        rcvPhotoVault = findViewById(R.id.rcvPhotoVault);
        folderAdapter = new FolderAdapter(this);

        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        rcvPhotoVault.setLayoutManager(gridLayoutManager);
        list = new ArrayList<>();
        folderAdapter.setData(loadDataFolder());
        rcvPhotoVault.setAdapter(folderAdapter);
        loadDataFolder();
        ...
        folderAdapter.setOnItemClickListener(new FolderAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                statusApp = 1;
                Intent intent = new Intent(PhotoVaultActivity.this, ViewFileInFolder.class);
    ...
    private void openBottomSheetDialog() {
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String strFolderName = albumName.getText().toString();
                if (TextUtils.isEmpty(strFolderName)) {
                    return;
                }
                String name = strFolderName;
                File file = new File(MainActivity.getStore(PhotoVaultActivity.this) + "/.HidePhoto/Photo", name);
                if (!file.exists()) {
                    file.mkdirs();
                    list.add(new Folder(R.drawable.ic_folder, name, 0, file.getAbsolutePath(), ""));
                    folderAdapter.setData(list);
                    Toast.makeText(PhotoVaultActivity.this, R.string.createFolderSuccessfully, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(PhotoVaultActivity.this, R.string.folderExist, Toast.LENGTH_SHORT).show();
                }
                bottomSheetDialog.dismiss();
            }
        });
...
//    private boolean isUserExist(Folder folder){
//        List<Folder> list= FolderDatabase.getInstance(this).folderDAO().checkUser(folder.getNameFolder());
//        return list!=null && !list.isEmpty();
//    }
//
//    private void loadData() {
//        list= FolderDatabase.getInstance(this).folderDAO().getListFolderPhoto();
//        folderAdapter.setData(list);
//    }

//    private List<File> takeAllFolderPhoto(){
//        String path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/.HidePhoto/.Photo";
...
//    }
    ...
    private List<File> takeAllFolderPhoto1() {
        ...
        String path = MainActivity.getStore(this) + "/.HidePhoto/Photo";
        ...
        builder.forNativeAd(
                new NativeAd.OnNativeAdLoadedListener() {
                    ...
                    public void onNativeAdLoaded(NativeAd nativeAd) {
                        ...
                        if (PhotoVaultActivity.this.nativeAd != null) {
                            PhotoVaultActivity.this.nativeAd.destroy();
                        }
                        PhotoVaultActivity.this.nativeAd = nativeAd;
